...
function validerFormulaire() {
  const NomRegex = /^[A-Za-zÀ-ÖØ-öø-ÿ-]+$/      /* RELATIVE EXPRESSION */
   const PrenomRegex = /^[A-Za-zÀ-ÖØ-öø-ÿ-]+$/ /* RELATIVE EXPRESSION */
 ...
 //-----------------------------------------------------------------------------------
  ...
  const email = document.getElementById("email");
   const erreurEmail = document.getElementById("erreur4");
    const emailPattern = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/; /* RELATIVE EXPRESSION */
